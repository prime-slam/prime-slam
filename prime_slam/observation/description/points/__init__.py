...
import prime_slam.observation.description.points.superpoint_descriptor as superpoint_descriptor_module
...
from prime_slam.observation.description.points.superpoint_descriptor import *
...
__all__ += superpoint_descriptor_module.__all__
